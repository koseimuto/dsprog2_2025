...
class CalculatorApp(ft.Container):
    ...
    def button_clicked(self, e):
        ...
        # 科学計算ボタンの処理
            ...
            self.result.value = self.format_number(math.sin(val))
            self.reset()
            
        elif data == "cos":
            val = float(self.result.value)
            self.result.value = self.format_number(math.cos(val))
            self.reset()

        elif data == "tan":
            val = float(self.result.value)
            self.result.value = self.format_number(math.tan(val))
            self.reset()
